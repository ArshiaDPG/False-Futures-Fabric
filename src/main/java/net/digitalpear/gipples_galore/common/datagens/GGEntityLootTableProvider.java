...
public class GGEntityLootTableProvider extends SimpleFabricLootTableProvider {
    ...
    public void accept(BiConsumer<RegistryKey<LootTable>, LootTable.Builder> lootTableBiConsumer) {
        ...
        lootTableBiConsumer.accept(GGEntityTypes.ANEUPLOIDIAN.getLootTableKey().get(), LootTable.builder()
                ...
                .pool(LootPool.builder().with(ItemEntry.builder(GGItems.MUSIC_DISC_GIPPLECORE)).conditionally(EntityPropertiesLootCondition.builder(LootContext.EntityTarget.DIRECT_ATTACKER, EntityPredicate.Builder.create().type(EntityTypePredicate.create(registryLookup.getOrThrow(RegistryKeys.ENTITY_TYPE), GGEntityTypes.ANEUPLOIDIAN)))).build())
        );

        lootTableBiConsumer.accept(GGEntityTypes.GIPPLE.getLootTableKey().get(), LootTable.builder()
                ...
                .pool(LootPool.builder().with(ItemEntry.builder(GGItems.GAPPLE)).conditionally(EntityPropertiesLootCondition.builder(LootContext.EntityTarget.DIRECT_ATTACKER, EntityPredicate.Builder.create().type(EntityTypePredicate.create(registryLookup.getOrThrow(RegistryKeys.ENTITY_TYPE), GGEntityTypes.ANEUPLOIDIAN)))).build())
        );
    }
}
