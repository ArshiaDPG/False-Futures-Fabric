...
public class GGStatusEffects {
    public static final RegistryEntry<StatusEffect> GIPPLE = register(GipplesGalore.id("gipple"), new ParasiteStatusEffect<>(GGEntityTypes.GIPPLE, GGDamageTypes.GIPPLE_EFFECT, 0xc6d1f2, GGParticleTypes.GIPPLE, GGSoundEvents.ENTITY_GIPPLE_AMBIENT.value(), GGSoundEvents.ENTITY_GIPPLE_HURT));
