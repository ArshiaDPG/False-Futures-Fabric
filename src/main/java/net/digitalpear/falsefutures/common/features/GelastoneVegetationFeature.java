...
public class GelastoneVegetationFeature extends Feature<NetherForestVegetationFeatureConfig> {
    public GelastoneVegetationFeature(Codec<NetherForestVegetationFeatureConfig> codec) {
        super(codec);
    }
