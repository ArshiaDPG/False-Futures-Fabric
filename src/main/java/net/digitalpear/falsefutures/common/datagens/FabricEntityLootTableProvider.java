...
public class FabricEntityLootTableProvider extends SimpleFabricLootTableProvider {
    ...
    public void accept(BiConsumer<Identifier, LootTable.Builder> identifierBuilderBiConsumer) {
        identifierBuilderBiConsumer.accept(Registries.ENTITY_TYPE.getId(FFEntities.SOMETHING), LootTable.builder()
        ...
        identifierBuilderBiConsumer.accept(Registries.ENTITY_TYPE.getId(FFEntities.GIPPLE), LootTable.builder()
